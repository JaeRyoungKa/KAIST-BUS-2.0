...
if (isWeekends) {
    ...
    warningSign += '<span style = "margin-bottom:2px; font-size: 0.78rem;" >현재 보시고 계시는 시간표는 휴일 전용 시간표입니다.</span><br>';
    warningSign += '<span style = "margin-bottom:2px; font-size: 0.78rem;" >탑승하고자 하는 날짜가 주말 및 공휴일이 맞는지 다시 한 번 확인해주세요.</span>';
    warningSign += '</div></div>';
